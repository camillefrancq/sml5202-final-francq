...
<p><button type="button" class="new-quote button">Show Idiom</button></p>
<dl id="quote"></dl>

<script>
 //const endpoint = 'https://api.whatdoestrumpthink.com/api/v1/quotes/random';
 //const endpoint = 'https://api.quotable.io/random';
const endpoint = 'https://camillefrancq.github.io/SML5202-Camillefrancq/datasets/idioms.json';
